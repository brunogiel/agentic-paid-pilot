...
Basado en un piloto real (leadgen B2B a negocios locales por vertical). El pipeline queda descrito acá de forma genérica: mismo diseño, sin nombres de archivos ni datos del caso original.
